...
const Footer = () => {
  return (
    <footer className="bg-[var(--bg-footer)] border-t border-[var(--border-teal)] text-slate-300 font-sans">
      
      {/* Clinical Disclaimer Banner */}
      <div className="bg-[var(--bg-main)] border-b border-[var(--border-teal)] py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex items-start sm:items-center space-x-3 text-[var(--accent-teal)] text-xs sm:text-sm">
          <ShieldAlert className="w-5 h-5 shrink-0 mt-0.5 sm:mt-0" />
          <p className="text-slate-200">
            <strong className="font-semibold text-[var(--accent-teal)]">Academic &amp; Research Disclaimer:</strong> This application serves benchmark models for Wisconsin Diagnostic Breast Cancer classification. It is not certified for standalone clinical diagnostic decisions.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm font-medium">
              <li><Link to="/" className="hover:text-[var(--accent-teal)] transition-colors">Home Overview</Link></li>
