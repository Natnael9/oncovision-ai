...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#091214]/90 backdrop-blur-xl border-b border-[#00e5ce]/15 border-t-2 border-t-[#00e5ce]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <Link
              to="/predict"
              className="p-2.5 rounded-lg border border-[#00e5ce]/30 bg-[#042a2d]/60 text-[#00e5ce] hover:bg-[#00e5ce] hover:text-[#051416] transition-all"
            ...
            <a
              ...
              className="p-2.5 rounded-lg border border-slate-700/60 bg-[#091214] text-slate-300 hover:border-[#00e5ce]/40 hover:text-white transition-all"
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#091214] border-b border-[#00e5ce]/20 px-4 py-4 space-y-3">
          {navLinks.map((link) => (
            <Link
              key={link.path}
              to={link.path}
