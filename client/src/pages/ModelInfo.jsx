    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12 font-sans">
      ...
      <div className="bg-bio-card rounded-3xl p-8 border border-[#00e5ce]/20 space-y-6">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-xl bg-[#0d4044] text-[#00e5ce] flex items-center justify-center font-bold border border-[#00e5ce]/30">
            <Database className="w-5 h-5" />
          </div>
          <div>
            <h2 className="font-display text-2xl font-extrabold text-white">Dataset Summary Specs</h2>
            <p className="text-xs text-slate-300">University of Wisconsin Clinical Sciences Center (Dr. William H. Wolberg, W. Nick Street, Olvi L. Mangasarian)</p>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-[#0f1d21] rounded-2xl p-5 border border-slate-700/80 space-y-1">
            <span className="text-xs text-slate-300 font-semibold">Total Sample Count</span>
          ...
          <div className="bg-[#0f1d21] rounded-2xl p-5 border border-slate-700/80 space-y-1">
            <span className="text-xs text-slate-300 font-semibold">Class Balance</span>
            <p className="font-display text-3xl font-extrabold text-emerald-400">357 B / 212 M</p>
            <p className="text-[11px] text-slate-300">62.7% Benign vs. 37.3% Malignant</p>
          </div>

          <div className="bg-[#0f1d21] rounded-2xl p-5 border border-slate-700/80 space-y-1">
            <span className="text-xs text-slate-300 font-semibold">Input Attributes</span>
            <p className="font-display text-3xl font-extrabold text-[#00e5ce]">30</p>
            <p className="text-[11px] text-slate-300">Real-valued continuous features</p>
          </div>

          <div className="bg-[#0f1d21] rounded-2xl p-5 border border-slate-700/80 space-y-1">
            <span className="text-xs text-slate-300 font-semibold">Selected Classifier</span>
            <p className="font-display text-xl font-extrabold text-[#00e5ce]">Random Forest</p>
            <p className="text-[11px] text-slate-300">100 Estimators Ensemble</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-bio-card rounded-3xl p-8 border border-[#00e5ce]/20 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-300 font-mono hidden sm:block">Test Set N=114 (20% Split)</span>
        </div>

        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-slate-200">
            <thead className="bg-[#0f1d21] text-xs text-slate-300 uppercase font-display font-semibold border-b border-slate-700">
              <tr>
            ...
            <tbody className="divide-y divide-slate-700/80 bg-[#14252a]/60">
              
              <tr className="bg-[#0d4044]/40 border-l-4 border-l-[#00e5ce]">
              ...
              <tr>
                ...
                <td className="py-4 px-6 font-mono text-slate-200">97.37%</td>
                <td className="py-4 px-6 font-mono text-slate-300">96.49% (±1.85%)</td>
                <td className="py-4 px-6 font-mono text-slate-200">0.98</td>
                <td className="py-4 px-6">
                  <span className="px-2.5 py-1 rounded bg-[#0f1d21] text-slate-300 text-xs font-medium">Benchmarked</span>
                </td>
              </tr>

              <tr>
                <td className="py-4 px-6 font-semibold text-slate-200">Logistic Regression (L2 Regularization)</td>
                <td className="py-4 px-6 font-mono text-slate-200">96.49%</td>
                <td className="py-4 px-6 font-mono text-slate-300">95.09% (±2.41%)</td>
                <td className="py-4 px-6 font-mono text-slate-200">0.97</td>
                <td className="py-4 px-6">
                  <span className="px-2.5 py-1 rounded bg-[#0f1d21] text-slate-300 text-xs font-medium">Benchmarked</span>
                </td>
              </tr>
      ...
      <div className="bg-bio-card rounded-3xl p-8 border border-[#00e5ce]/20 space-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-300">Relative contribution of nuclear morphometrics to Random Forest decision splits</p>
          </div>
        </div>
            ...
            <div key={idx} className="space-y-1.5">
              <div className="flex items-center justify-between text-xs sm:text-sm font-semibold">
                <span className="text-slate-200 capitalize flex items-center gap-2">
                  <span className="w-5 h-5 rounded bg-[#0f1d21] text-[#00e5ce] flex items-center justify-center text-[10px] font-bold">#{idx + 1}</span>
                  {item.feature}
                </span>
                <span className="font-mono text-[#00e5ce] font-extrabold">{item.importance}%</span>
              </div>

              <div className="w-full h-3 bg-[#0f1d21] rounded-full overflow-hidden p-0.5 border border-slate-700/80">
                <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-bio-card rounded-3xl p-6 border border-[#00e5ce]/20 space-y-4">
          <h3 className="font-display text-xl font-bold text-white">Confusion Matrix (Test Set N=114)</h3>
          <div className="rounded-2xl overflow-hidden border border-slate-700 bg-[#0f1d21] p-2">
      ...
      <div className="rounded-2xl p-6 bg-[#0f1d21] border border-[#00e5ce]/30 flex items-start space-x-4">
